...
import (
	...
	req "github.com/tizips/uper-go/admin/http/request/site"
	res "github.com/tizips/uper-go/admin/http/response/site"
	"github.com/tizips/uper-go/model"
	"gorm.io/gorm"
	"gorm.io/gorm/clause"
)

func ToUserByPaginate(ctx context.Context, c *app.RequestContext) {
	...
	tx := facades.Gorm.Where("exists (?)", ter)
...
func DoUserByCreate(ctx context.Context, c *app.RequestContext) {
	...
	vr := facades.Gorm.Where("`id` IN (?)", request.Roles)
...
func DoUserByUpdate(ctx context.Context, c *app.RequestContext) {
...
func DoUserByDelete(ctx context.Context, c *app.RequestContext) {
...
func DoUserByEnable(ctx context.Context, c *app.RequestContext) {
